    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="text-sm text-gray-600">
                {formatPercentage(metrics.cash_percentage)}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          ...
          <PortfolioChart data={portfolio?.top_holdings || []} />
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {portfolio?.top_winners?.slice(0, 5).map((position, index) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {Object.entries(portfolio?.sector_allocation || {}).slice(0, 4).map(([sector, data]) => (
